...
@section('content')
    <div>
        <section class="mb-7">
            <h1 class="text-xl mb-5 font-bold">Create Tag</h1>
            <form action="{{ route('tags.store') }}" method="post">
                @csrf
                <div class="mb-4 flex flex-col gap-1">
                    <label for="name" class="text-xs">Name</label>
                    <input type="text" name="name" class="py-2 px-4 w-3/6 rounded outline-none border border-gray-400 text-xs" placeholder="Name here...">
