...
@section('content')
    <div>
        <section class="mb-7">
            <h1 class="text-xl mb-5 font-bold">Edit Category</h1>
            <form action="{{ route('categories.update') }}" method="post">
                ...
                <div class="mb-4 flex flex-col gap-1">
                    ...
                    <input type="text" name="name" value="{{ $category->name }}" class="py-2 px-4 w-3/6 rounded outline-none border border-gray-400 text-xs" placeholder="Title here...">
